...
let ListsController = class ListsController {
    ...
    create(folderId, createListDto) {
        createListDto.folder_id = folderId;
        return this.listsService.create(createListDto);
    }
    findAllByFolder(folderId) {
...
__decorate([
    ...
    (0, common_1.Post)('folders/:folderId/lists'),
...
__decorate([
    (0, common_1.Get)('folders/:folderId/lists'),
    __param(0, (0, common_1.Param)('folderId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ListsController.prototype, "findAllByFolder", null);
__decorate([
