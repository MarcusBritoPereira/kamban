...
export declare class TasksController {
    ...
    create(listId: string, createTaskDto: CreateTaskDto): Promise<{
        id: string;
        created_at: Date;
        updated_at: Date;
    ...
    findAllByList(listId: string): import(".prisma/client").Prisma.PrismaPromise<({
        tags: ({
            tag: {
                id: string;
                name: string;
    ...
    addAssignee(id: string, addAssigneeDto: AddAssigneeDto): Promise<{
        user_id: string;
        task_id: string;
    }>;
    ...
    addTag(id: string, addTagDto: AddTagDto): Promise<{
        task_id: string;
        tag_id: string;
    }>;
